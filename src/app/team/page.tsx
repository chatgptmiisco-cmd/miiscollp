...
const teamMembers: TeamMember[] = [
...

  {
    ...
    skills: ["SQL", "API Automation", "JMeter", "Python"],
    linkedin: "#",
  },
  {
    name: "Rahul Sen",
